...
const Feed = () => {
    const { data: postsResponse, isLoading: isLoadingPosts, mutate: mutatePosts, size: postsSize, setSize: setPostsLimit, error } = useSWRInfinite((index) => ['/api/downvoted-posts', index], ([, index]) => getFeed(PAGE_SIZE, index + 1));
